...
class BeaconsServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
BeaconsServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_1.Descriptor('beacons', 'persistence', 'memory', '*', '1.0');
BeaconsServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_1.Descriptor('beacons', 'persistence', 'file', '*', '1.0');
BeaconsServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_1.Descriptor('beacons', 'persistence', 'mongodb', '*', '1.0');
BeaconsServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor('beacons', 'controller', 'default', '*', '1.0');
BeaconsServiceFactory.HttpServiceV1Descriptor = new pip_services_commons_node_1.Descriptor('beacons', 'service', 'http', '*', '1.0');
