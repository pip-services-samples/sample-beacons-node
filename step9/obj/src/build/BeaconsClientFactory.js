...
class BeaconsClientFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
BeaconsClientFactory.NullClientDescriptor = new pip_services_commons_node_1.Descriptor('beacons', 'client', 'null', '*', '1.0');
BeaconsClientFactory.DirectClientDescriptor = new pip_services_commons_node_1.Descriptor('beacons', 'client', 'direct', '*', '1.0');
BeaconsClientFactory.HttpClientDescriptor = new pip_services_commons_node_1.Descriptor('beacons', 'client', 'http', '*', '1.0');
